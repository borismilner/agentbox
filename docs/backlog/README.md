...
> **In a hurry.** Finish robustness band A (ten items left, about two weeks),
...
**Tier 1 - the claim is false while these stand.** Robustness band A, the ten
...
tier 1 is therefore robustness band A's ten (R-05 onwards; R-03, R-04 and R-14
were all fixed on 2026-08-09) plus U-16, and U-16 wants one more repro before its fix is chosen: it
