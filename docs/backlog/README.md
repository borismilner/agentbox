...
> **In a hurry.** Finish robustness band A (eleven items left, under three weeks),
...
**Tier 1 - the claim is false while these stand.** Robustness band A, the eleven
...
tier 1 is therefore robustness band A's eleven (R-04 onwards; R-03 and R-14 were
both fixed on 2026-08-09) plus U-16, and U-16 wants one more repro before its fix is chosen: it
